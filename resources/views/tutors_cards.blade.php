...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex"><h4 class="content-title mb-0 my-auto">Tutors</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ Available</span></div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <button type="button" class="btn btn-warning  btn-icon ml-2" onclick="refreshPage()"><i
            ...
            @foreach ($chunk as $tutor)
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="card text-center">
                        <div class="card-body">
                            <img class="card-img-top" src="{{asset($tutor->image)}}"
                                 onerror="this.onerror=null;this.src='{{asset('images/tutor.png')}}';">
                            <br>
                            <hr class="line">
                            <h4 class="card-title mb-3">Name: {{$tutor->name}}</h4>
                            <h4 class="card-title mb-3">Birth
                                Date: {{\Carbon\Carbon::parse($tutor->birth_date)->format('Y-m-d')}}</h4>
                            <table style="margin-right:65px">
                                ...
                                <th><a class="btn btn-primary"
                                       href="{{route('Parent.tutor_info',$tutor->id)}}">Review</a></th>
