					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">In this table al list of all parents registered to our website.</p>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-10p border-bottom-0">Birth Date</th>
												<th class="wd-25p border-bottom-0">Join date</th>
											</tr>
										</thead>
										<tbody>
											<tr>
