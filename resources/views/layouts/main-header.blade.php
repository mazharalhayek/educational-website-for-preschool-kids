            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ asset(Auth::user()->user_type->image) }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <a href="{{ route('Tutor.updateinterface') }}">
                                    <div class="main-img-user"><img alt=""
                                            src="{{ asset(Auth::user()->user_type->image) }}" class=""></div>
                                </a>
                        ...
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            @method('post')
                            <a class="dropdown-item"><button type="submit" value="logout"
                                    style="border: none;background-color:white"><i class="bx bx-log-out"></i>Sign
                                    Out</button></a>
                        </form>
                        </form>
                    </div>
