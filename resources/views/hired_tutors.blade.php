                                ...
                                <div class="card-body h-100">
                                    <div class="row row-sm ">
                                        ...
                                        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                            ...
                                            <p class="text-muted tx-13 mb-1">{{$item->subject}}</p>
                                            ...
                                            <h6 class="price">current price (Monthly): <span class="h3 ml-2">${{$item->salary}}</span></h6>
                                            <p class="product-description">{{$item->qualifications}}</p>
