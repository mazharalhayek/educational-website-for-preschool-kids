                           ...
                           >
                            <div class="u-container-layout u-valign-middle u-container-layout-2"><b>
                                    <div class="registration">
                                        ...
                                        <h8>Don't have an account? <a href="{{ route('register') }}"> SignUp</a></h8>
                                        <br>
                                    ...
                                    <div class="welome_intro">
                                        ...
                                        <p
                                            ...
                                            Join our community , whether you are a tutor who wants to be in our tutors
                                            team
                                            & teach the new generation or a parent who wants to put their children on
                                            the
        ...
        <div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-1">
            ...
            <div class="u-form u-form-1">
                <form action="https://forms.nicepagesrv.com/v2/form/process"
                    class="u-clearfix u-form-horizontal u-form-spacing-26 u-inner-form" source="email" name="form"
                    style="padding: 0px;">
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                <table>
                    ...
                    <td style="padding:10px">
                        <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Gallery</a></li>
                    </td>
                    <td style="padding:10px">
