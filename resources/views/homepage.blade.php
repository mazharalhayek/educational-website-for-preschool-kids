        ...
        @if ($errors->any())
            @foreach ($errors->all() as $error)
                <div class="alert alert-danger errors alert-dismissible fade show" role="alert">
                    <ul>
                        <li>
                            <h8>Wrong password or username</h8>
                        </li>
                    </ul>
                </div>
            @endforeach
        ...
        <table id="teachers">
            <tr>
                @foreach($tutors as $tutor)
                    <th>
                        <a href="#tutorInfo" data-toggle="modal">
                            <button type="submit" style="border: none; background: none; padding: 0; margin: 0;"><img
                                    src="{{asset($tutor->image)}}"
                                    class="teachers_pics">
                            </button>
                        </a>
                    </th>
                    <div id="tutorInfo" class="modal fade">
                        <div class="modal-dialog custom-modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" style="color:black">Tutor info</h4>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="inputName"
                                                   placeholder="Name" name="name" value="{{$tutor->name}}" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:black">E-mail:</label>
                                            <input type="text" min="0" max="8" class="form-control"
                                                   id="inputEmail3" placeholder="Age" name="age"
                                                   value="{{$tutor->email}}" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:black">Birth date:</label>
                                            <input type="text" class="form-control" id="inputPassword3"
                                                   placeholder="birth" name="birth"
                                                   value="{{$tutor->birth_date}}" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:black">Subject:</label>
                                            <input type="text" class="form-control" id="childpic"
                                                   placeholder="subject" value="{{$tutor->subject}}"
                                                   name="text" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:black">Qualifications:</label>
                                            <textarea class="form-control"
                                                      disabled>{{$tutor->qualifications}}</textarea>
                                        </div>
                                    </div>
                                </div>
...
<footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-176d" style="height:1cm">
    <div class="u-clearfix u-sheet u-sheet-1">
        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
            <table>
                ...
                <td style="padding:10px">
                    <li class="u-nav-item"><a class="u-button-style u-nav-link" data-toggle="modal" href="#gallery">Gallery</a>
                    </li>
                </td>
                <td style="padding:10px">
                    <li class="u-nav-item"><a class="u-button-style u-nav-link" data-toggle="modal" href="#FAQ">FAQ</a>
                    </li>
                </td>
                </th>
            </table>
    ...
    <div id="FAQ" class="modal fade">
        <div class="modal-dialog custom-modal-dialog">
            <div style="background: rgba(254,254,254,0.7)" class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="color:black">Frequently Asked Questions</h4>
                </div>
                <div class="modal-body" style="color: black">
                    <div class="form-group">
                        <div class="form-group">
                            <label style="color:black">Who are we?</label>
                            <h6>We are a vibrant community dedicated to nurturing young minds through engaging,
                                interactive, and fun-filled learning experiences.</h6>
                        </div>
                        <div class="form-group">
                            <label style="color:black">What is our mission?</label>
                            <h6>
                                Our mission is to inspire curiosity, foster creativity, and build a strong foundation
                                for future learning.
                            </h6>
                        </div>
                        <div class="form-group">
                            <label style="color:black">Why us?</label>
                            <h6>
                                We create a safe, supportive environment where every child can explore, experiment, and
...
<section class="u-backlink u-clearfix u-grey-80">
    ...
    <a class="u-link" href="#" target="_blank">
        <span>Childlearn developers</span>
    </a>.
</section>
<script>
