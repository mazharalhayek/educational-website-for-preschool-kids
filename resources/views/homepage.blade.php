...
c0-7.4,3.4-18.8,18.8-18.8h13.8v15.4H75.5z"></path></svg></span>
        ...
        <div class="u-form u-form-1">
          <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-horizontal u-form-spacing-26 u-inner-form" source="email" name="form" style="padding: 0px;">
            <div class="u-form-email u-form-group u-label-none">
              ...
              <input type="email" placeholder="Enter a valid email address" id="email-6564" name="email" class="u-input u-input-rectangle u-radius-50" required="">
            </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-176d"><div class="u-clearfix u-sheet u-sheet-1">
        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
            <table >
                <th>
                    <td style="padding:10px"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Home</a></li></td>
                    <td style="padding:10px"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Landing</a></li></td>
                    <td style="padding:10px"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">About</a></li></td>
                    <td style="padding:10px"> <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Gallery</a></li></td>
                    <td style="padding:10px"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Contact</a></li></td>
                </th>
            </table>
        </ul>
      </div></footer>
