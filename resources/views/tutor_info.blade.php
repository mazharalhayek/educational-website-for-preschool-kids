...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Tutors</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Info</span>
						</div>
					</div>
							...
							<div class="card-body h-100">
								<div class="row row-sm ">
									...
									<div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
										...
										<h6 class="price">current price (Monthly): <span class="h3 ml-2">${{$specific_tutor->salary}}</span></h6>
                                                    ...
                                                    <table >
                                                        <tr>
                                                            @foreach ($which_child as $child)
                                                               <th style="padding:10px" ><button class="add-to-cart btn btn-success" name="child_id" type="submit" value="{{$child->id}}">Hire for {{$child->name}}</button></th>
                                                            @endforeach
                                                        </tr>
                                                    </table>
                                                </div>
