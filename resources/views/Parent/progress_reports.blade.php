...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">My Children</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Progress Reports</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="card-body">
                        ...
                        <div class = "container">
                            ...
                            <div class="progress mg-b-10">
                                @foreach ($child->my_progress as $progress)
