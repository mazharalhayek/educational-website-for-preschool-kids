					...
					<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">Children accounts only.</p>
							</div>
							<div class="card-body">
								<div class="table-responsive border-top userlist-table">
									<table class="table card-table table-striped table-vcenter text-nowrap mb-0">
										...
										<tbody>
											...
											<tr>
												<td>
													<img alt="avatar" class="rounded-circle avatar-md mr-2" src="{{asset('images/'.$account->image)}}" onerror="this.onerror=null;this.src='{{ asset('images/kids3.png') }}';">
												</td>
												<td>{{$account->name}}</td>
												<td>
												...
												<td>
													<a href="#">{{$account->my_parent->name}}</a>
												</td>
                                                <td>
													<a href="#" style="text-decoration: none;color: inherit;">{{$account->age}}</a>
												</td>
												<td>
