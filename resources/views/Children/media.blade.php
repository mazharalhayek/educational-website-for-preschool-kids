        ...
        <div class="content-container pt-3 content-container-fix">
            @foreach ($medias as $media)
                ...
                <div class="card" style="width: 24rem; max-height: 600px;">
                    <img src="{{asset($media->Cover)}}" class="card-img-top" alt="..." style="height: 65%">
                    <div class="card-body">
                        <h5 class="card-title">{{$media->title}}</h5>
                        <a onclick="openFile()" style="text-decoration: none">Open</a>
                        <script>
                            function openFile() {
                ...
                <ul class="nav flex-column mx-auto mt-3 pt-2">
                    <li class="nav-item mt-4">
                        <a class="nav-link active" aria-current="page"
                           href="{{ route('child_interface', ['id' => $child->id]) }}"
                           style="color: white">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link" href="{{route('viewReport', ['id' => $child->id])}}"
                           style="color: white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70"
                                 fill="currentColor"
