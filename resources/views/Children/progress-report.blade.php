                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center px-4 py-6">
                                <div class="echart-total-orders"
                                     ...
                                     _echarts_instance_="ec_1703798064471">
                                    <div
                                        style="position: relative; width: 115px; height: 85px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
                                        <canvas data-zr-dom-id="zr_0" width="172" height="127"
                        ...
                        <div class="card-body">
                            ...
                            <div class="pb-0 pt-4">
                                <div class="echarts-new-customers"
                                     ...
                                     _echarts_instance_="ec_1703798064466">
                                    <div
                                        style="position: relative; width: 495px; height: 180px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
                                        <canvas data-zr-dom-id="zr_0" width="742" height="270"
                                                style="position: absolute; left: 0px; top: 0px; width: 495px; height: 180px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                                    </div>
                                    <div class=""
                                         style="position: absolute; display: block; border-style: solid; white-space: nowrap; z-index: 9999999; box-shadow: rgba(0, 0, 0, 0.2) 1px 2px 10px; background-color: rgb(239, 242, 246); border-width: 1px; border-radius: 4px; color: rgb(20, 24, 36); font: 14px / 21px &quot;Microsoft YaHei&quot;; padding: 10px; top: 0px; left: 0px; transform: translate3d(325px, 43px, 0px); border-color: rgb(203, 208, 221); pointer-events: none; visibility: hidden; opacity: 0;">
                                        <div class="ms-1">
                                            <h6 class="fs-9 text-body-tertiary false">
                                                <svg class="svg-inline--fa fa-circle me-2" style="color: #5470c6;"
                                                ...
                                                <!-- <span class="fas fa-circle me-2" style="color:#5470c6"></span> Font Awesome fontawesome.com -->
                                                May 07 : 250
                                            </h6>
                                            <h6 class="fs-9 text-body-tertiary mb-0">
                                                <svg class="svg-inline--fa fa-circle me-2" style="color: #91cc75;"
                                                     aria-hidden="true" focusable="false" data-prefix="fas"
                                                     data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 512 512" data-fa-i2svg="">
                                                    <path fill="currentColor"
                                                ...
                                                <!-- <span class="fas fa-circle me-2" style="color:#91cc75"></span> Font Awesome fontawesome.com -->
                                                Apr 07 : 600
                                            </h6>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="pb-4 pt-3">
                                <div class="echart-top-coupons"
                                     ...
                                     _echarts_instance_="ec_1703798064467">
                                    <div
                                        style="position: relative; width: 495px; height: 115px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
                                        <canvas data-zr-dom-id="zr_0" width="742" height="172"
                                                style="position: absolute; left: 0px; top: 0px; width: 495px; height: 115px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                                    </div>
                                    <div class=""></div>
                                </div>
                            </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-center pt-3 flex-1">
                                <div class="echarts-paying-customer-chart"
                                     ...
                                     _echarts_instance_="ec_1703798064470">
                                    <div
                                        style="position: relative; width: 495px; height: 144px; padding: 0px; margin: 0px; border-width: 0px;">
                                        <canvas data-zr-dom-id="zr_0" width="742" height="216"
                                                style="position: absolute; left: 0px; top: 0px; width: 495px; height: 144px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                                    </div>
                                    <div class=""></div>
                                </div>
                            </div>
    ...
    <div class="col mt-3 ms-3  | sidebar">
        <ul class="nav flex-column mx-auto mt-3 pt-2">
            <li class="nav-item mt-4">
                <a class="nav-link active" aria-current="page" href="{{route('child_interface',$child->id)}}"
                   style="color: white">
