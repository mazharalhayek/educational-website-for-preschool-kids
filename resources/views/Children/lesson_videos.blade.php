    ...
    <div class = "grid-container" style = "margin-right: 800px">
        ...
        <!-- Main Content Container -->
            ...
            <div class="content-container pt-3" >
             <video id="myVideo" controls width="1250" height="700">
                @switch($subject)
                    @case("letters")
                        <source src="{{asset('videos/letters-video.mp4')}}" type="video/mp4">
                        @break
                    @case("math")
                        <source src="{{asset('videos/numbers-video.mp4')}}" type="video/mp4">
                        @break
                    @case("shapes")
                        <source src="{{asset('videos/shapes-video.mp4')}}" type="video/mp4">
                    @default
                        <h1>Unavailable subject</h1>
                @endswitch
             </video>
            </div>
        <!-- SideBar -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        video.addEventListener('ended', function() {
            ...
            $.ajax({
                url: "{{route('incrementProgress',['child_id' => $child->id,'role'=>'lesson'])}}",
                method: "post",
                headers: {
