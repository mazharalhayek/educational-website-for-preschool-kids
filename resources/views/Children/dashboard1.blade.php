    ...
    <div class="grid-container" style="margin-right: 800px">
        ...
        <div class="content-container pt-3">
            <div class="contents text-center">
                <a href="{{route('subject_page',['subject'=>'letters','child'=>$child->id])}}"><img
                        src="/images/letter-lesson.png" alt="letters" class="img-fluid rounded img-thumbnail"
                        style="min-height: 400px"></a>
            </div>
            <div class="contents text-center">
                <a href="{{route('subject_page',['subject'=>'math','child'=>$child->id])}}"><img
                        src="/images/math-logo.webp" alt="math" class="img-fluid rounded img-thumbnail"
                        style="min-height: 400px"></a>
            </div>
            <div class="contents text-center">
                <a href="{{route('subject_page',['subject'=>'shapes','child'=>$child->id])}}"><img
                        src="/images/shape-logo.jpg" alt="shape" class="img-fluid rounded img-thumbnail"
            ...
            <div class="contents text-center">
                <a href="{{route('getBooks', ['id' => $child->id])}} ">
                    <img src="/images/book-logo.png" alt="book" class="img-fluid rounded img-thumbnail"
                         style="min-height: 400px"></div>
            </a>
        </div>
        <!-- SideBar -->
        <div class="col mt-3 ms-3  | sidebar">
            <ul class="nav flex-column mx-auto mt-3 pt-2">
                ...
                <li class="nav-item pt-2">
                    <a class="nav-link" href="{{route('MyMedia',[$child->id])}}" style="color: white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor"
